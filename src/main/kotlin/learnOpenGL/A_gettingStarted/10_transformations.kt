...
private class Transformations {
    ...
    init {
        ...
        window = GlfwWindow(800, 600, "Transformations")
        ...
        with(window) {
            ...
            framebufferSizeCallback = this@Transformations::framebuffer_size_callback
        }
        ...
        ourShader = shaderOf(this::class, "shaders/A_10", "transform")
