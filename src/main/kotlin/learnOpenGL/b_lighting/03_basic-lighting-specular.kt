...
private class BasicLightingSpecular {
    ...
    init {
        ...
        with(window) {
            ...
            framebufferSizeCallback = this@BasicLightingSpecular::framebuffer_size_callback
            cursorPosCallback = this@BasicLightingSpecular::mouse_callback
            scrollCallback = this@BasicLightingSpecular::scroll_callback
