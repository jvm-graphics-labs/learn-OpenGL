...
private class LightCastersSpot {
    ...
    init {
        ...
        window = GlfwWindow(800, 600, "Light Caster Spot")
        ...
        with(window) {
            ...
            framebufferSizeCallback = this@LightCastersSpot::framebuffer_size_callback
            cursorPosCallback = this@LightCastersSpot::mouse_callback
            scrollCallback = this@LightCastersSpot::scroll_callback
        ...
        lighting = Lighting("shaders/b/_09", "light-casters")
